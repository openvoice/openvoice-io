...
Gem::Specification.new do |s|
  ...
  s.files = [".document", ".gitignore", "HISTORY.rdoc", "LICENSE", "README.rdoc", "Rakefile", "VERSION", "examples/sinatra_server.rb", "lib/tropo-webapi-ruby.rb", "lib/tropo-webapi-ruby/tropo-webapi-ruby-helpers.rb", "lib/tropo-webapi-ruby/tropo-webapi-ruby.rb", "spec/spec.opts", "spec/spec_helper.rb", "spec/tropo-webapi-ruby_spec.rb", "tropo-webapi-ruby.gemspec"]
