var RedBox = {
  ...
  {
    var inside_redbox = '<div id="RB_window" style="display: none;"></div><div id="RB_overlay" style="display: none;"></div>'
    if ($('RB_redbox'))
    {
  ...
  setOverlaySize: function()
  {
    ...
    { // Explorer Mac...would also work in Explorer 6 Strict, Mozilla and Safari
      yScroll = document.body.offsetHeight;
		...
		height = yScroll > document.viewport.getHeight() ? yScroll : document.viewport.getHeight();
